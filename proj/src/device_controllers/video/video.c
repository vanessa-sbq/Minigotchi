...
/**
 * @brief Function that helps get information about a video mode.
 */
...
/**
 * @brief Function that helps map the video ram.
 */
int video_map_vram(){
    ...
    video_mem = vm_map_phys(SELF, (void *)mr.mr_base, vram_size); // Map memory
...
/**
 * @brief Function that helps set the desired video mode
 * @param mode
 *
 */
